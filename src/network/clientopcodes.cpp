...
const ToClientCommandHandler toClientCommandTable[TOCLIENT_NUM_MSG_TYPES] =
{
	...
	{ "TOCLIENT_TERMINAL_DATA",             TOCLIENT_STATE_CONNECTED, &Client::handleCommand_TerminalData }, // 0x65,
	{ "TOCLIENT_TERMINAL_INIT",             TOCLIENT_STATE_CONNECTED, &Client::handleCommand_TerminalInit }, // 0x66,
	{ "TOCLIENT_TERMINAL_DIFF",             TOCLIENT_STATE_CONNECTED, &Client::handleCommand_TerminalDiff }, // 0x67,
};
...
const ServerCommandFactory serverCommandFactoryTable[TOSERVER_NUM_MSG_TYPES] =
{
	...
	{ "TOSERVER_TERMINAL_KEY",       0, true }, // 0x54
};
