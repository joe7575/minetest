...
private:
	...
	void handleClientEvent_TerminalInit(ClientEvent *event, CameraOrientation *cam);
	void handleClientEvent_TerminalDiff(ClientEvent *event, CameraOrientation *cam);
